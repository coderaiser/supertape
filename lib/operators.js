...
const called = (fn, message = 'should called') => {
    const is = fn.called;
    const output = '';
...
const notCalled = (fn, message = 'should called') => {
    const is = !fn.called;
    const output = '';
...
const calledWith = (fn, args, message = 'should called') => {
    const is = fn.calledWith(...args);
    const output = '';
...
const notCalledWith = (fn, args, message = 'should called') => {
    const is = !fn.calledWith(...args);
    const output = '';
...
module.exports.initOperators = ({out, count, incCount, incPassed, incFailed}) => {
    ...
    return {
        ...
        calledWith: operator('calledWith'),
        ok: operator('ok'),
